...
public:
    ...
    void setupUi(QMainWindow *Puncher)
    {
        ...
        ctrlButton->setPalette(palette3);
        ...
        resetButton->setPalette(palette4);
        resetButton->setAutoRepeatInterval(110);
        ...
        menuBar->setGeometry(QRect(0, 0, 300, 27));
        QPalette palette5;
        ...
        mainToolBar->setPalette(palette6);

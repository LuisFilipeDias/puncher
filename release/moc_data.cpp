...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Data_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 53, 22),
QT_MOC_LITERAL(7, 76, 22),
QT_MOC_LITERAL(8, 99, 34)
    },
    "Data\0set_hours\0\0fill_date\0status\0"
    "on_data_raw_clicked\0on_data_cancel_clicked\0"
    "on_data_update_clicked\0"
...
void Data::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { status _r = _t->fill_date();
            if (_a[0]) *reinterpret_cast< status*>(_a[0]) = _r; }  break;
        case 2: _t->on_data_raw_clicked(); break;
        case 3: _t->on_data_cancel_clicked(); break;
        case 4: _t->on_data_update_clicked(); break;
        ...
        {
            typedef void (Data::*_t)(int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Data::set_hours)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Data::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Data.data,
      qt_meta_data_Data,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Data.stringdata))
...
// SIGNAL 0
void Data::set_hours(int _t1, int _t2, int _t3)
{
